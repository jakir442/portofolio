...
const Skills = () => {
  return (
    <>
      ...
      md:bg-circularLightLMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm"
      >
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold bg-dark text-light p-6 
        ...
        <Skill name="Github" x="-20vw" y="11vw" />
        <Skill name="JavaScript" x="-6vw" y="-11vw" />
        <Skill name="CSS" x="20vw" y="5vw" />
        <Skill name="Java" x="0vw" y="12vw" />
        <Skill name="NextJS" x="-20vw" y="-16vw" />
        <Skill name="MongoDB" x="-36vw" y="-3vw" />
        <Skill name="ReactJS" x="15vw" y="-14vw" />
        <Skill name="Web Design" x="33vw" y="-7vw" />
        <Skill name="SQL" x="0vw" y="-20vw" />
        <Skill name="Firebase" x="-25vw" y="20vw" />
