    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink href="/articels" title="Articels" className="ml-4" />
        </nav>

        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/jakir442"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
          ...
          <motion.a
            href="https://twitter.com/JakirApr"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/jakir-uciha-2689492a9/"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://id.pinterest.com/jakirapriyan04"
            target={"_blank"}
      ...
      {isOpen ? (
        ...
        >
          <nav className="flex items-center flex-col justify-center">
            ...
            <CustomMobileLink href="/articels" title="Articels" className="" toggle={handleClick} />
          </nav>
