...
import profilePic from "../../public/images/profile/foto1.png";
...
export default function Home() {
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen mb-16 dark:text-light">
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full mr-8">
              <Image
                src={profilePic}
                alt="Hi Kids"
        ...
        <div className="absolute right-8 -bottom-12 inline-block w-24 md:hidden">
          <Image src={lightBlub} alt="Hi Kids" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
